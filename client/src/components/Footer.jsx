                    ...
                    <div>
                        <Link to="/" className="flex items-center mb-6">
                            {!logoError ? (
                                ...
                                <span className="text-2xl font-bold font-display uppercase">Adzenity</span>
                            )}
                        </Link>
                        ...
                        <div className="flex gap-3">
                            {socialLinks.map((social) => (
                                <a
                                    key={social.name}
                                    href={social.href}
                                    className="w-10 h-10 rounded-full bg-white/10 hover:bg-accent hover:text-primary flex items-center justify-center transition-all duration-300"
                    ...
                    <div>
                        ...
                        <ul className="space-y-4">
                            <li className="flex items-start gap-3">
                                ...
                                <span className="text-white/70">D85, sector 63 noida, 201301</span>
                            </li>
                            <li className="flex items-center gap-3">
                                ...
                                <a href="mailto:info@adzenity.com" className="text-white/70 hover:text-accent transition-colors">
                                    info@adzenity.com
                                </a>
                            </li>
                            <li className="flex items-center gap-3">
                                ...
                                <a href="tel:+919560203481" className="text-white/70 hover:text-accent transition-colors">
                                    +919560203481
                                </a>
                            </li>
                        </ul>
