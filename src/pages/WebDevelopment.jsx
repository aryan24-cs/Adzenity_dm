            ...
            <section className="py-12 bg-gray-900">
                <div className="max-w-7xl mx-auto px-6">
                    <div className="text-center mb-8">
                        <span className="text-gray-400 text-sm font-medium uppercase tracking-wider">Technologies We Use</span>
                    </div>
                    <div className="flex flex-wrap justify-center gap-4">
                        {technologies.map((tech, idx) => (
                            <AnimateOnScroll key={idx} animation="fade-in-up" delay={idx * 50}>
                                <span className="bg-gray-800 px-6 py-3 rounded-full text-white font-semibold border border-gray-700 hover:border-primary transition-colors">
                                    {tech}
                                </span>
                            </AnimateOnScroll>
                        ))}
